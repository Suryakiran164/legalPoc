  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm border border-line bg-white p-8 rounded-sm">
        ...
        <p className="text-sm text-ink/55 mb-6">Registers you as an Inspector by default.</p>
        ...
        <label className="block text-xs font-medium text-ink/60 mb-1">Password (6+ characters)</label>
        ...
        <p className="text-sm text-ink/55 mt-5 text-center">
          Already registered? <Link to="/login" className="text-brass font-medium">Sign in</Link>
        </p>
      </form>
    </div>
  );
